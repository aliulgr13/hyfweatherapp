    ...
    <Router>
      <div className="App">
        <Switch>
          ...
          <h1 style={{ color: '#f0a500',textShadow: '-3px 0 #cf7500, 0 3px #cf7500, 3px 0 #cf7500, 0 -3px #cf7500', fontSize: '60px',fontWeight: 'bold' }}>HYF WEATHER APP</h1>
            ...
            {citiesInfos.length > 0 ? citiesInfos.map((cityInf, index) => (
              ...
              <h3 style={{ color: '#0764D3',textShadow: '-2px 0 #1f4068, 0 2px #1f4068, 2px 0 #1f4068, 0 -2px #1f4068', fontSize: '30px', fontWeight: 'bold' }}>You Can Enter More Than One City</h3>
            }
